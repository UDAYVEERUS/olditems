...
VIJENDRA SINGH believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
...
VIJENDRA SINGH does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
...
In case of any Refunds approved by the VIJENDRA SINGH, it'll take 1-2 days for the refund to be processed to the end customer.
    </div>
  )
}
