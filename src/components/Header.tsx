        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6 flex-1 mx-8">
              <Link
                href="/"
                className="text-gray-700 hover:text-[#E06B2D] font-medium"
              >
                Home
              </Link>
              <Link
              ...
              <div className="relative max-w-xl w-full" ref={desktopSearchRef}>
                ...
                >
                  ...
                  <div className="relative flex-1">
                    ...
                    <button
                      type="submit"
                      className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-600 hover:text-[#E06B2D]"
                    >
                      <Search size={20} />
                    </button>
                  </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-[#E06B2D] text-sm font-semibold">
              ...
              {user ? (
                <div className="relative" ref={userDropdownRef}>
                  <button
                    ...
                    className="flex items-center justify-center w-10 h-10 bg-[#E06B2D] text-white rounded-full hover:bg-blue-700 text-base font-semibold"
                    title={user.name}
                  >
                ...
                <div className="flex gap-2">
                  <Link
                    href="/login"
                    className="px-2 py-2 w-full text-[#E06B2D] border border-blue-600 rounded-lg hover:bg-blue-50"
                  >
                    Login
                  </Link>
                </div>
              ...
              <nav className="p-4 space-y-2">
                ...
                {user ? (
                  ...
                  <div className="space-y-2 pt-4 border-t">
                    <Link
                      href="/login"
                      className="block px-3 py-2 text-center text-[#E06B2D] border border-blue-600 rounded-lg hover:bg-blue-50"
                      onClick={() => setShowMobileMenu(false)}
                    >
                      Login
                    </Link>
            ...
            <div className="p-4">
              ...
              <form onSubmit={handleSearch} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <button
                    type="submit"
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[#E06B2D] hover:text-blue-700"
                  >
                    <Search size={20} />
                  </button>
                </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-sm text-[#E06B2D] font-semibold">
                                ₹{product.price.toLocaleString("en-IN")}
                              </div>
                            </div>
                          </div>
